...
#         let(:venta) { build :venta, :tipo_a, fields }
#       end
...
#         let(:venta) { build :venta, field => value }
#         it 'is ok' do
#           expect(FieldPrinter.new(venta).print(method_name)).to eq expected_return
#         end
#       end
...
#         # it_behaves_like 'abstract', 'receptor_doc_nro', '12345678901', 'receptor_doc_tipo', '80'
#         it_behaves_like 'abstract', 'receptor_doc_nro', nil, 'receptor_doc_tipo', '99'
#       end

#       context 'receptor_doc_nro' do
#         it_behaves_like 'abstract', 'receptor_doc_nro', '12345678901', 'receptor_doc_nro', '00000000012345678901'
#         it_behaves_like 'abstract', 'receptor_doc_nro', nil, 'receptor_doc_nro', '00000000099999999999'
#       end

#       context 'receptor_razon_social' do
#         it_behaves_like 'abstract', 'receptor_razon_social', 'HOLA', 'receptor_razon_social', 'HOLA                          '
#         it_behaves_like 'abstract', 'receptor_razon_social', 'JUAN Roberto Carlos JUAN Roberto Carlos JUAN Roberto Carlos', 'receptor_razon_social', 'JUAN ROBERTO CARLOS JUAN ROBER'
#       end
